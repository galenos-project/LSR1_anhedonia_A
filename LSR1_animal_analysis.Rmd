...
rows_with_bold_lines <- c(1,4,5,6,7,8,10,11,12,13,14,15,16,18,21,22,25,26,27,28,29,30,33,34,35,36)
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=18}
...
The p-value for the association between the duration of treatment and outcome reported was `r round(SMD_S_SPT_DurRx_noI$QMp,3)`.
...
The p-value for the association between the intervention administered and outcome reported was `r round(SMD_S_SPT_Drug_noI$QMp,3)`.
...
| Moderator | Category | SMD | 95% CI | Marginal R^2^ % |
|:-----------:|:-----------:|:-----------:|:------------------:|:-----------:|
| Overall effect (unadjusted model) | \- | `r SMD_S_SPT$SMD_ML$beta[1]` | `r SMD_S_SPT$SMD_ML$ci.lb` to `r SMD_S_SPT$SMD_ML$ci.ub` | \- |
...
| \- | *Behavioural early life stress* | `r SMD_S_SPT_CatDisIndI$beta[2]` | `r SMD_S_SPT_CatDisIndI$ci.lb[2]` to `r SMD_S_SPT_CatDisInd_noI$ci.ub[2]` | \- |
| \- | *Chronic unpredictable mild stress* | `r SMD_S_SPT_CatDisIndI$beta[1]` | `r SMD_S_SPT_CatDisIndI$ci.lb[1]` to `r SMD_S_SPT_CatDisIndI$ci.ub[1]` | \- |
| \- | *Genetic models* | `r SMD_S_SPT_CatDisIndI$beta[4]` | `r SMD_S_SPT_CatDisIndI$ci.lb[4]` to `r SMD_S_SPT_CatDisIndI$ci.ub[4]` | \- |
| \- | *Pharmacological early life stress* | `r SMD_S_SPT_CatDisIndI$beta[5]` | `r SMD_S_SPT_CatDisIndI$ci.lb[5]` to `r SMD_S_SPT_CatDisIndI$ci.ub[5]` | \- |
| \- | *Pharmacological post weaning* | `r SMD_S_SPT_CatDisIndI$beta[6]` | `r SMD_S_SPT_CatDisIndI$ci.lb[6]` to `r SMD_S_SPT_CatDisIndI$ci.ub[6]` | \- |
| \- | *Social or social defeat stress* | `r SMD_S_SPT_CatDisIndI$beta[3]` | `r SMD_S_SPT_CatDisIndI$ci.lb[3]` to `r SMD_S_SPT_CatDisIndI$ci.ub[3]` | \- |
...
| \- | D-amphetamine | `r SMD_S_SPT_DrugI$beta[7]` | `r SMD_S_SPT_DrugI$ci.lb[7]` to `r SMD_S_SPT_DrugI$ci.ub[7]` | \- |
| \- | *dopamine* | `r SMD_S_SPT_DrugI$beta[8]` | `r SMD_S_SPT_DrugI$ci.lb[8]` to `r SMD_S_SPT_DrugI$ci.ub[8]` | \- |
| \- | *L-DOPA* | `r SMD_S_SPT_DrugI$beta[9]` | `r SMD_S_SPT_DrugI$ci.lb[9]` to `r SMD_S_SPT_DrugI$ci.ub[9]` | \- |
| \- | *P.orientalis seed* | `r SMD_S_SPT_DrugI$beta[10]` | `r SMD_S_SPT_DrugI$ci.lb[10]` to `r SMD_S_SPT_DrugI$ci.ub[10]` | \- |
| \- | *piribedil* | `r SMD_S_SPT_DrugI$beta[11]` | `r SMD_S_SPT_DrugI$ci.lb[11]` to `r SMD_S_SPT_DrugI$ci.ub[11]` | \- |
| \- | *pramipexole* | `r SMD_S_SPT_DrugI$beta[12]` | `r SMD_S_SPT_DrugI$ci.lb[12]` to `r SMD_S_SPT_DrugI$ci.ub[12]` | \- |
| \- | *quinpirole* | `r SMD_S_SPT_DrugI$beta[13]` | `r SMD_S_SPT_Drug$analysis$ci.lb[13]` to `r SMD_S_SPT_Drug$analysis$ci.ub[13]` | \- |
| \- | *ropinirole* | `r SMD_S_SPT_DrugI$beta[14]` | `r SMD_S_SPT_DrugI$ci.lb[14]` to `r SMD_S_SPT_DrugI$ci.ub[14]` | \- |
| \- | *selegiline* | `r SMD_S_SPT_DrugI$beta[15]` | `r SMD_S_SPT_DrugI$ci.lb[15]` to `r SMD_S_SPT_DrugI$ci.ub[15]` | \- |
| \- | *simvastatin* | `r SMD_S_SPT_DrugI$beta[16]` | `r SMD_S_SPT_DrugI$ci.lb[16]` to `r SMD_S_SPT_DrugI$ci.ub[16]` | \- |
| \- | *SKF38393* | `r SMD_S_SPT_DrugI$beta[17]` | `r SMD_S_SPT_DrugI$ci.lb[17]` to `r SMD_S_SPT_DrugI$ci.ub[17]` | \- |
| \- | *SKF83959* | `r SMD_S_SPT_DrugI$beta[18]` | `r SMD_S_SPT_DrugI$ci.lb[18]` to `r SMD_S_SPT_DrugI$ci.ub[18]` | \- |
| \- | *tranylcypromine* | `r SMD_S_SPT_DrugI$beta[19]` | `r SMD_S_SPT_DrugI$ci.lb[19]` to `r SMD_S_SPT_DrugI$ci.ub[19]` | \- |
...
Dopaminergic agents had a pooled effect on dopamine concentration of SMD = `r round(SMD_S_DA[['beta']], 3)` (95% CI: `r round(SMD_S_DA[['ci.lb']], 3)` to `r round(SMD_S_DA[['ci.ub']], 3)`; 95% PrI: `r round(predict(SMD_S_DA)[['pi.lb']], 3)` to `r round(predict(SMD_S_DA)$pi.ub, 3)`).
...
| \- | *Social or social defeat stress* | `r SMD_S_SPT_CatDisIndI$beta[2]` | `r SMD_S_SPT_CatDisIndI$ci.lb[2]` to `r SMD_S_SPT_CatDisIndI$ci.ub[2]` | \- |
...
```{r message=FALSE, warning=FALSE, eval=TRUE, echo=FALSE, results='hide', fig.height=10}
