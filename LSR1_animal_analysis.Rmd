...
|            Level            |                                               Number of categories for that level included in this analysis                                               |                                                                   Attributable variance                                                                   |
|:----------------------:|:----------------------:|:----------------------:|
|           Strain            |                        `r ifelse('Strain' %in% SMD_S_SPT_ARR2$analysis$s.names, SMD_S_SPT_ARR2$analysis$s.nlevels[[which(SMD_S_SPT_ARR2$analysis$s.names == 'Strain')]], 0)`                        |                         `r ifelse('Strain' %in% SMD_S_SPT_ARR2$analysis$s.names, SMD_S_SPT_ARR2$analysis$sigma2[[which(SMD_S_SPT_ARR2$analysis$s.names == 'Strain')]], NA)`                         |
|       Study x Strain        |                `r ifelse('Strain/StudyId' %in% SMD_S_SPT_ARR2$analysis$s.names, SMD_S_SPT_ARR2$analysis$s.nlevels[[which(SMD_S_SPT_ARR2$analysis$s.names == 'Strain/StudyId')]], 0)`                |                 `r ifelse('Strain/StudyId' %in% SMD_S_SPT_ARR2$analysis$s.names, SMD_S_SPT_ARR2$analysis$sigma2[[which(SMD_S_SPT_ARR2$analysis$s.names == 'Strain/StudyId')]], NA)`                 |
| Study x Strain x Experiment | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_SPT_ARR2$analysis$s.names, SMD_S_SPT_ARR2$analysis$s.nlevels[[which(SMD_S_SPT_ARR2$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)` | `r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_SPT_ARR2$analysis$s.names, SMD_S_SPT_ARR2$analysis$sigma2[[which(SMD_S_SPT_ARR2$analysis$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')` |
